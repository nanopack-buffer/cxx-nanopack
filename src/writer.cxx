...
void NanoPack::Writer::write_type_id(int32_t type_id) {
...
void NanoPack::Writer::write_int32(int32_t num, int offset) {
...
void NanoPack::Writer::append_int8(int8_t num) { buffer->emplace_back(num); }
...
void NanoPack::Writer::append_bool(bool b) { buffer->emplace_back(b ? 1 : 0); }
