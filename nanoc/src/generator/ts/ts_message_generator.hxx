#ifndef NANOPACK_NANOC_TS_MESSAGE_GENERATOR_HXX
#define NANOPACK_NANOC_TS_MESSAGE_GENERATOR_HXX

#include "../data_type_code_generator.hxx"

class TsMessageGenerator final : public DataTypeCodeGenerator {
  public:
...
#endif // NANOPACK_NANOC_TS_MESSAGE_GENERATOR_HXX
