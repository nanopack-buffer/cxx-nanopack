#ifndef NANOPACK_NANOC_TS_OPTIONAL_GENERATOR_HXX
#define NANOPACK_NANOC_TS_OPTIONAL_GENERATOR_HXX

#include "../data_type_code_generator.hxx"

class TsOptionalGenerator final : public DataTypeCodeGenerator {
  private:
	std::shared_ptr<DataTypeCodeGeneratorRegistry> generator_registry;

  public:
	explicit TsOptionalGenerator(
		std::shared_ptr<DataTypeCodeGeneratorRegistry> generator_registry);
...
#endif // NANOPACK_NANOC_TS_OPTIONAL_GENERATOR_HXX
