#ifndef NANOPACK_NANOC_TS_ARRAY_GENERATOR_HXX
#define NANOPACK_NANOC_TS_ARRAY_GENERATOR_HXX

#include "../data_type_code_generator.hxx"

class TsArrayGenerator final : public DataTypeCodeGenerator {
  private:
	std::shared_ptr<DataTypeCodeGeneratorRegistry> generator_registry;

  public:
	explicit TsArrayGenerator(
		std::shared_ptr<DataTypeCodeGeneratorRegistry> generator_registry);
...
#endif // NANOPACK_NANOC_TS_ARRAY_GENERATOR_HXX
