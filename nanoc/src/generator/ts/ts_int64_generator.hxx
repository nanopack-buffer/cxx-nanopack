#ifndef NANOPACK_NANOC_TS_INT64_GENERATOR_HXX
#define NANOPACK_NANOC_TS_INT64_GENERATOR_HXX

#include "../data_type_code_generator.hxx"

class TsInt64Generator final : public DataTypeCodeGenerator {
  public:
