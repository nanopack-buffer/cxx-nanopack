#ifndef NANOPACK_NANOC_TS_MAP_GENERATOR_HXX
#define NANOPACK_NANOC_TS_MAP_GENERATOR_HXX

#include "../data_type_code_generator.hxx"

class TsMapGenerator final : public DataTypeCodeGenerator {
private:
...
#endif //NANOPACK_NANOC_TS_MAP_GENERATOR_HXX
