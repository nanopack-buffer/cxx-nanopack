#ifndef NANOPACK_NANOC_SWIFT_STRING_GENERATOR_HXX
#define NANOPACK_NANOC_SWIFT_STRING_GENERATOR_HXX

#include "../data_type_code_generator.hxx"

class SwiftStringGenerator : public DataTypeCodeGenerator {
  public:
...
#endif // NANOPACK_NANOC_SWIFT_STRING_GENERATOR_HXX
