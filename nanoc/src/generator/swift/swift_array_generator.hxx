#ifndef NANOPACK_NANOC_SWIFT_ARRAY_GENERATOR_HXX
#define NANOPACK_NANOC_SWIFT_ARRAY_GENERATOR_HXX

#include "../data_type_code_generator.hxx"
#include <memory>

class SwiftArrayGenerator : public DataTypeCodeGenerator {
  private:
	std::shared_ptr<DataTypeCodeGeneratorRegistry> generator_registry;

  public:
	explicit SwiftArrayGenerator(
		std::shared_ptr<DataTypeCodeGeneratorRegistry> generator_registry);
...
#endif // NANOPACK_NANOC_SWIFT_ARRAY_GENERATOR_HXX
