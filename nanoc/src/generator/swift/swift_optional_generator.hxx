#ifndef NANOPACK_NANOC_SWIFT_OPTIONAL_GENERATOR_HXX
#define NANOPACK_NANOC_SWIFT_OPTIONAL_GENERATOR_HXX

#include "../data_type_code_generator.hxx"
#include <memory>

class SwiftOptionalGenerator : public DataTypeCodeGenerator {
  private:
	std::shared_ptr<DataTypeCodeGeneratorRegistry> generator_registry;

  public:
	explicit SwiftOptionalGenerator(
		std::shared_ptr<DataTypeCodeGeneratorRegistry> generator_registry);
...
#endif // NANOPACK_NANOC_SWIFT_OPTIONAL_GENERATOR_HXX
