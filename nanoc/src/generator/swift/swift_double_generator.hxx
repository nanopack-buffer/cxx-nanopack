#ifndef NANOPACK_NANOC_SWIFT_DOUBLE_GENERATOR_HXX
#define NANOPACK_NANOC_SWIFT_DOUBLE_GENERATOR_HXX

#include "../data_type_code_generator.hxx"

class SwiftDoubleGenerator : public DataTypeCodeGenerator {
  public:
...
#endif // NANOPACK_NANOC_SWIFT_DOUBLE_GENERATOR_HXX
