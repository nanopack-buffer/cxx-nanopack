#ifndef NANOPACK_NANOC_SWIFT_BOOL_GENERATOR_HXX
#define NANOPACK_NANOC_SWIFT_BOOL_GENERATOR_HXX

#include "../data_type_code_generator.hxx"

class SwiftBoolGenerator : public DataTypeCodeGenerator {
...
#endif // NANOPACK_NANOC_SWIFT_BOOL_GENERATOR_HXX
