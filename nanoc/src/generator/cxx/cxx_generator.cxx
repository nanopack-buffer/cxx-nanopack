...
void CxxGenerator::generate_code_file(const MessageSchema &schema,
	...
	// clang-format off
	output_file.stream()
	<< schema.message_name << "::" << schema.message_name << "(const std::vector<uint8_t>::const_iterator begin, int &bytes_read)";
	// clang-format on
