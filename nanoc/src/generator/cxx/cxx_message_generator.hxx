#ifndef NANOPACK_NANOC_CXX_MESSAGE_GENERATOR_HXX
#define NANOPACK_NANOC_CXX_MESSAGE_GENERATOR_HXX

#include "../data_type_code_generator.hxx"

class CxxMessageGenerator : public DataTypeCodeGenerator {
  public:
	CxxMessageGenerator();
...
#endif // NANOPACK_NANOC_CXX_MESSAGE_GENERATOR_HXX
